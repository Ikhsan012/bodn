...
sourceUrl: `https://wa.me/6287846614391`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }}}}
...
var taaofc = [
 ...
 '..',
 '...',
 'ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️Loading selesai!'
]
...
reply(`
┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️
┆ ☂︎ 𝚄𝚜𝚎𝚛 : ${pushname}
┆ ☂︎ 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 : ${isPrem ? '✅' : '❎'}
┆ ☂︎ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${hariini}
┆ ☂︎ 𝙹𝚊𝚖: ${time} WIB❄️
...
⭔Nama Script : *ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️*
⭔Versi Script : *2.0*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
//=================================================//
        ...
        case 'addprem':
if (!isCreator) return errorReply(mess.owner)
if (!args[0]) return reply(`Use ${prefix+command} number\nExample ${prefix+command} 6287846614391`)
...
⭔Versi Bot : *2.3*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️*
⭔Nomor Bot : *wa.me/62878466143916*
⭔Type Baileys : *Case*
⭔Source Code : *${okta}*
...
await loading()
m.reply(`¥ *Price Sewa Bot ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️* €
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️`);
});
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6287846614391',
title: `ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️`,
sourceUrl: `https://wa.me/6287846614391`, 
thumbnail: thumb
}
}})
...
okta.sendMessage(from, {image: { url: result }, caption: 'ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
m.reply(`*ᴘʀᴏᴊᴇᴄᴛ IkhsanDev ❄️ Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
